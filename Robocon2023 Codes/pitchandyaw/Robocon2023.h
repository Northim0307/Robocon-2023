...
void ICM20948_GET_READING_QUAT6(double *pitch, double *yaw)
{
	double roll;
...
// void getInitialYaw(float *initial_yaw)
 void getInitialYaw(double *initial_pitch, double *initial_yaw)
{
  ...
  while ( *initial_yaw == 0 && *initial_yaw ==0)
	{
      ICM20948_GET_READING_QUAT6(&pitch_now, &yaw_now);
